    ...
    *,
    ...
    manifest = build_manifest(
        ...
        llm_state={
            ...
            "agent3": {"model_id": "Qwen/Qwen2.5-72B-Instruct"},
            "agent4": {"model_id": "meta-llama/Llama-3.3-70B-Instruct"},
            "agent5_bull": {"model_id": "Qwen/Qwen2.5-72B-Instruct"},
            "agent5_bear": {"model_id": "meta-llama/Llama-3.3-70B-Instruct"},
            "agent5_arbiter": {"model_id": "deepseek-ai/DeepSeek-R1-Distill-Llama-70B"},
        },
        parameters={
            "threshold_pct": 10,
